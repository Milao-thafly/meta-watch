...
import {Form,useLoaderData, useSubmit, redirect} from 'react-router';
...
export async function addMeleeAdminLoader () {
...
export const AddMeleeAdmin = () => {
    ...
    return(
        ...
        <div className='register_page'>
            <h1 className='title_reg'>Add Melee</h1>
            <Form className='register_form' method='post'>
                ...
                <div className='div_label'>
                    <label htmlFor="Stamina">Precision</label>
                </div>
                <input type="text" className='form_input'name='precision'/>

                <div className='div_label'>
                    <label htmlFor="Save">Strength</label>
                </div>
